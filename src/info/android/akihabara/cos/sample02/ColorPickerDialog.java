...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // canvas.drawText("OK", 0 - 12, (float) (CENTER_X * 1.2) + 22,
            // textPaint);
            ...
            if (mTrackingOK) {
                ...
                // mOKPaint.getStrokeWidth(), mOKPaint);
                canvas.drawRoundRect(new RectF(OK_X0 - padding, OK_Y0 - padding, OK_X1 + padding,
                        OK_Y1 + padding), 5, 5, mOKPaint);
                mOKPaint.setStyle(Paint.Style.FILL);
                mOKPaint.setColor(c);
            }
        }
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mTrackingOK) {
                    ...
                    int selectColor2 = setHSVColor(selectHue, (x - OK_X0) / CENTER_X, (y - OK_X0)
                            / CENTER_Y);
